      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0a081e;color:#fff;border-radius:16px;overflow:hidden">
          ...
          <div style="padding:32px">
            ...
            <p style="color:rgba(255,255,255,0.7);line-height:1.7;margin:0 0 20px">Your Coursiv password was successfully changed. If you did not make this change, contact us immediately.</p>
