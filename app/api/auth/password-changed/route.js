...
export async function POST(req) {
  try {
    ...
    await resend.emails.send({
      ...
      to: user.email,
      subject: "🔐 Your Coursiv password was changed",
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0a081e;color:#fff;border-radius:16px;overflow:hidden">
          ...
          <div style="padding:32px">
            ...
            <p style="color:rgba(255,255,255,0.7);line-height:1.7;margin:0 0 20px">Your Coursiv account password was successfully changed. If you did not make this change, please contact us immediately.</p>
          ...
          <div style="padding:20px 32px;border-top:1px solid rgba(255,255,255,0.08);text-align:center">
            <p style="color:rgba(255,255,255,0.3);font-size:12px;margin:0">© 2026 Coursiv. If this wasn't you, contact support immediately.</p>
          </div>
        </div>
      `,
    });
