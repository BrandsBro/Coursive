    ...
    <div style={{ minHeight:"100vh", background:"#fff", display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ position:"sticky", top:0, background:"#fff", zIndex:50 }}>
        <div style={{ padding: isMobile ? "10px 14px" : "14px 20px", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          ...
          <img src={branding.logoApp||"https://i.postimg.cc/7Pd7vVJs/1course-Logo-Black-Version.png"} alt="1Course" className="logo-app" style={{ objectFit:"contain", visibility: branding.loaded ? "visible" : "hidden", padding:4, maxHeight: isMobile ? 30 : 40 }}/>
      ...
      <div style={{
        ...
        {isInEndSequence && (
          <EndBlock step={endStep} loadingPct={loadingPct} email={email} setEmail={setEmail} name={name} setName={setName} answers={answers} blocks={visibleBlocks} showToast={setToast} isMobile={isMobile}/>
        )}
      </div>
