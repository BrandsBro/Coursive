...
const DEFAULT_BLOCKS = [
  ...
  },
  {
    id: "b5",
    type: "text",
    text: "You have successfully joined 1Course. Start your AI learning journey today!",
  ...
  { id: "b9", type: "divider", color: "rgba(255,255,255,0.08)", margin: 24 },
  {
    id: "b10",
    type: "footer",
    text: "© 2026 1Course. All rights reserved.",
  ...
  const blockHtml = (blocks || [])
    .map((b) => {
      switch (b.type) {
        ...
        case "logo":
          if (!b.logoUrl)
            return `<div style="padding:20px 40px;text-align:${b.align || "center"}"><p style="color:rgba(255,255,255,0.3);font-size:12px;margin:0">[Logo placeholder]</p></div>`;
...
export default function EmailTemplateEditor({ templateId }) {
  ...
  const save = async () => {
    ...
    await supabase
      .from("settings")
      .upsert({ key: "email_templates", value: updated });
    setSaved(true);
    ...
    <AdminLayout>
      ...
      >
        ...
        >
          ...
          />
          <select
            value={template.trigger || "manual"}
            onChange={(e) => u("trigger", e.target.value)}
            style={{
              padding: "7px 10px",
              borderRadius: 9,
              border: "1.5px solid #E2E8F0",
        ...
        >
          ...
          >
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "8px 10px",
                      borderRadius: 8,
                      border: `1.5px solid ${selectedId === b.id ? "#5B4EFF" : dragOver === b.id ? "#C7D2FE" : "transparent"}`,
                      background:
                        selectedId === b.id
                          ? "#EEF2FF"
                          : dragOver === b.id
                  ...
                  >
                    <span
                      style={{ fontSize: 13, opacity: 0.5, cursor: "grab" }}
                    >
                      ⠿
                    </span>
            ...
            <div
              style={{ padding: "12px 10px", borderTop: "1px solid #E2E8F0" }}
            >
              <p
                style={{
                  fontSize: 10,
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                <CF
                  label="Email BG"
                  value={template.emailBg || "#050411"}
                  onChange={(v) => u("emailBg", v)}
                />
                <CF
                  label="Card BG"
                  value={template.cardBg || "#0a081e"}
            ...
            >
              ...
              >
                <p style={{ fontSize: 11, color: "#64748B", margin: 0 }}>
                  To: <strong>john@example.com</strong> · Subject:{" "}
                  <strong>{template.subject || "(no subject)"}</strong>
                </p>
              </div>
              <div
              ...
              <div style={{ padding: 16 }}>
                ...
                >
                  <span style={{ fontSize: 18 }}>
                    {BLOCK_TYPES.find((x) => x.type === selBlock.type)?.icon}
                  </span>
                  <p
                    style={{
                      fontSize: 14,
                ...
                <BlockControls
                  block={selBlock}
                  onChange={(k, v) => updateBlock(selBlock.id, k, v)}
                  uploadImg={uploadImg}
                  uploading={uploading}
                />
              </div>
      ...
      return (
        <div style={col()}>
          <CF
            ...
            value={b.bg1 || "#5B4EFF"}
            onChange={(v) => onChange("bg1", v)}
          />
          <CF
            label="Gradient End"
            value={b.bg2 || "#8B5CF6"}
            onChange={(v) => onChange("bg2", v)}
          />
          <SF
            label="Padding (px)"
            value={b.padding || 48}
        ...
        <div style={col()}>
          ...
          >
            ...
            <input
              ...
              accept="image/*"
              style={{ display: "none" }}
              onChange={(e) => uploadImg(e.target.files[0], b.id)}
            />
          </label>
          {b.logoUrl && (
            <img
              src={b.logoUrl}
              alt=""
              style={{ maxHeight: 40, objectFit: "contain", borderRadius: 6 }}
            />
          )}
          <SF
            label="Height (px)"
            value={b.logoHeight || 44}
            onChange={(v) => onChange("logoHeight", v)}
          />
          <AF
            label="Align"
          ...
          <div style={{ display: "flex", gap: 6 }}>
            <button
              ...
              style={{
                ...
                padding: "6px",
                borderRadius: 7,
                border: `1.5px solid ${b.bold ? "#5B4EFF" : "#E2E8F0"}`,
                background: b.bold ? "#EEF2FF" : "#fff",
                fontWeight: 900,
                fontSize: 14,
                cursor: "pointer",
              }}
            ...
            <button
              ...
              style={{
                ...
                padding: "6px",
                borderRadius: 7,
                border: `1.5px solid ${b.italic ? "#5B4EFF" : "#E2E8F0"}`,
                background: b.italic ? "#EEF2FF" : "#fff",
                fontStyle: "italic",
                fontWeight: 700,
                fontSize: 14,
                cursor: "pointer",
        ...
        <div style={col()}>
          <div>
            <p style={lbl()}>
              Text{" "}
              <span style={{ color: "#94A3B8", fontWeight: 400 }}>
                · paste formatted text, bold, line breaks all work
              </span>
            </p>
            <div
              contentEditable
      ...
      return (
        <div style={col()}>
          ...
          <SF
            ...
            value={b.paddingV || 16}
            onChange={(v) => onChange("paddingV", v)}
          />
          <SF
            label="Padding Horizontal"
            value={b.paddingH || 32}
            onChange={(v) => onChange("paddingH", v)}
          />
          <AF
            label="Align"
            value={b.align || "center"}
    ...
    case "divider":
      return (
        <div style={col()}>
          <CF
            label="Color"
            value={b.color || "rgba(255,255,255,0.08)"}
            onChange={(v) => onChange("color", v)}
          />
          <SF
            label="Margin (px)"
    ...
    case "credentials":
      return (
        <div style={col()}>
          <CF
            label="Label Color"
            value={b.labelColor || "rgba(255,255,255,0.5)"}
            onChange={(v) => onChange("labelColor", v)}
          />
          <CF
            label="Email Color"
            value={b.emailColor || "#a78bfa"}
            onChange={(v) => onChange("emailColor", v)}
          />
          <CF
            label="Password Text"
            value={b.pwColor || "#fff"}
            onChange={(v) => onChange("pwColor", v)}
          />
          <CF
            label="Password BG"
            value={b.pwBg || "rgba(91,78,255,0.2)"}
            onChange={(v) => onChange("pwBg", v)}
          />
          <CF
            label="Card BG"
            value={b.cardBg || "#1a1830"}
            onChange={(v) => onChange("cardBg", v)}
          />
          <CF
            label="Card Border"
            value={b.cardBorder || "rgba(255,255,255,0.1)"}
    ...
    case "footer":
      return (
        <div style={col()}>
          ...
          <CF
            label="Text Color"
            value={b.color || "rgba(255,255,255,0.3)"}
            onChange={(v) => onChange("color", v)}
          />
          <CF
            label="Background"
            value={b.bg || "transparent"}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
        <button onClick={() => onChange(Math.max(0, value - 1))} style={ib()}>
          −
        </button>
        <span
          style={{
        ...
        <button onClick={() => onChange(value + 1)} style={ib()}>
          +
        </button>
      </div>
    </div>
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              height: 28,
              borderRadius: 7,
              border: `1.5px solid ${value === a ? "#5B4EFF" : "#E2E8F0"}`,
              background: value === a ? "#EEF2FF" : "#fff",
              cursor: "pointer",
              fontSize: 13,
            }}
          >
