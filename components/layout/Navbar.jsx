      ...
      <nav style={{ position:"sticky", top:0, zIndex:50,background:"white", width:"100%", borderRadius:"10px", borderBottom:"1px solid #F1F5F9", }}>
        <div style={{ maxWidth:1200, margin:"0 auto", padding:"0 16px", height:60, display:"flex", alignItems:"center", justifyContent:"space-between", gap:12 }}>
          ...
          <Link href="/home" style={{ textDecoration:"none", flexShrink:0 }}>
            <img src={branding.logoApp||"https://i.postimg.cc/7Pd7vVJs/1course-Logo-Black-Version.png"} alt="1Course" className="logo-app" style={{ objectFit:"contain", visibility: branding.loaded ? "visible" : "hidden", padding:5 }}/>
          </Link>
