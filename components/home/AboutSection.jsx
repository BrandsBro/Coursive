  ...
  return (
    <section id="about" style={{ padding: isMobile ? "48px 20px" : "80px 32px" }}>
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        ...
        <p style={{ textAlign:"center", fontSize:15, color:"rgba(255,255,255,0.5)", margin:"0 auto 48px", maxWidth:600, lineHeight:1.8 }}>1Course was built by a team of AI enthusiasts who believe that anyone — regardless of background — can master AI tools and transform their career.</p>
        <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap:20, marginBottom:48 }}>
          {[
            ...
            { icon:"🌍", title:"Our Impact", desc:"2,000,000+ learners across 150+ countries have transformed their careers with 1Course." },
          ].map((c,i) => (
        ...
        <div style={{ background:"linear-gradient(135deg,rgba(91,78,255,0.15),rgba(139,92,246,0.08))", border:"1px solid rgba(91,78,255,0.2)", borderRadius:24, padding: isMobile ? "28px 20px" : "40px 48px", display:"grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap:32, alignItems:"center" }}>
          <div>
            <h3 style={{ fontSize: isMobile ? 22 : 26, fontWeight:900, color:"#fff", margin:"0 0 12px" }}>Why we built 1Course</h3>
            ...
            <p style={{ fontSize:15, color:"rgba(255,255,255,0.55)", margin:0, lineHeight:1.8 }}>So we built 1Course — bite-sized, practical AI education that fits into your life and actually changes your results.</p>
          </div>
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            {[
              { year:"2023", event:"1Course founded with a vision to democratize AI education" },
