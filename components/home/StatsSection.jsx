    ...
    <section style={{ padding: isMobile ? "48px 20px" : "80px 32px" }}>
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:40 }}>
          <p style={{ fontSize: isMobile ? 20 : 28, fontWeight:900, color:"#ef4444", margin:"0 0 8px", lineHeight:1.3 }}>55K jobs lost to AI in 2025. <span style={{ color:"#fff" }}>12x more than two years ago</span></p>
        ...
        <div style={{ display:"grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4,1fr)", gap:16 }}>
          {[
            ...
            <div key={i} style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.07)", borderRadius:16, padding:"20px 16px", textAlign:"center" }}>
              <p style={{ fontSize: isMobile ? 26 : 32, fontWeight:900, color:"#5B4EFF", margin:"0 0 8px" }}>{s.value}</p>
