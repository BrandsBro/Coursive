...
export async function getStripeKey() {
  ...
  // Fallback to env var
  return mode === "live" ? process.env.STRIPE_LIVE_SECRET_KEY : process.env.STRIPE_SECRET_KEY;
}
...
export async function getStripePublishableKey() {
  ...
  return mode === "live" ? process.env.NEXT_PUBLIC_STRIPE_LIVE_PUBLISHABLE_KEY : process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY;
}
...
export async function getWebhookSecret() {
  ...
  return mode === "live" ? process.env.STRIPE_LIVE_WEBHOOK_SECRET : process.env.STRIPE_WEBHOOK_SECRET;
}
